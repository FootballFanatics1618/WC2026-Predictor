...
-- Data sourced from lib/data.js MATCHES array
--
-- IMPORTANT: This only updates schedule/fixture data. It does NOT touch result,
-- score_a, score_b, or any prediction data.
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-13'::date, '12:00'),
  team_a = 'Switzerland',
  team_b = 'Qatar',
  group_name = 'B',
...
UPDATE public.matches SET
  ...
  match_time = '02:00 ET',
  kickoff_utc = et_to_utc('2026-06-14'::date, '02:00'),
  team_a = 'Haiti',
  team_b = 'Scotland',
  group_name = 'C',
...
UPDATE public.matches SET
  match_date = '2026-06-14'::date,
  match_time = '05:00 ET',
  kickoff_utc = et_to_utc('2026-06-14'::date, '05:00'),
  team_a = 'Australia',
  team_b = 'Turkey',
  group_name = 'D',
  venue = 'SoFi Stadium, Los Angeles',
...
UPDATE public.matches SET
  match_date = '2026-06-14'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-06-14'::date, '15:00'),
  team_a = 'Spain',
  team_b = 'Cape Verde',
  group_name = 'H',
...
UPDATE public.matches SET
  match_date = '2026-06-14'::date,
  match_time = '18:00 ET',
  kickoff_utc = et_to_utc('2026-06-14'::date, '18:00'),
  team_a = 'Germany',
  team_b = 'Curacao',
  group_name = 'E',
...
UPDATE public.matches SET
  match_date = '2026-06-15'::date,
  match_time = '22:00 ET',
  kickoff_utc = et_to_utc('2026-06-15'::date, '22:00'),
  team_a = 'Argentina',
  team_b = 'Algeria',
  group_name = 'J',
...
UPDATE public.matches SET
  ...
  match_time = '09:00 ET',
  kickoff_utc = et_to_utc('2026-06-16'::date, '09:00'),
  team_a = 'Saudi Arabia',
  team_b = 'Uruguay',
  group_name = 'H',
  venue = 'Mercedes-Benz Stadium, Atlanta',
...
UPDATE public.matches SET
  match_date = '2026-06-16'::date,
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-16'::date, '12:00'),
  team_a = 'Egypt',
  team_b = 'Iran',
  group_name = 'G',
  venue = 'Lumen Field, Seattle',
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-17'::date, '12:00'),
  team_a = 'Sweden',
  team_b = 'Tunisia',
  group_name = 'F',
  venue = 'NRG Stadium, Houston',
...
UPDATE public.matches SET
  match_date = '2026-06-17'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-06-17'::date, '15:00'),
  team_a = 'Colombia',
  team_b = 'DR Congo',
  group_name = 'K',
  venue = 'Arrowhead Stadium, Kansas City',
...
UPDATE public.matches SET
  match_date = '2026-06-17'::date,
  match_time = '18:00 ET',
  kickoff_utc = et_to_utc('2026-06-17'::date, '18:00'),
  team_a = 'Ghana',
  team_b = 'Panama',
  group_name = 'L',
  venue = 'NRG Stadium, Houston',
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-19'::date, '12:00'),
  team_a = 'Qatar',
  team_b = 'Canada',
  group_name = 'B',
  venue = 'BC Place, Vancouver',
...
UPDATE public.matches SET
  match_date = '2026-06-19'::date,
  match_time = '21:00 ET',
  kickoff_utc = et_to_utc('2026-06-19'::date, '21:00'),
  team_a = 'Paraguay',
  team_b = 'Turkey',
  group_name = 'D',
  venue = 'SoFi Stadium, Los Angeles',
...
UPDATE public.matches SET
  ...
  match_time = '09:00 ET',
  kickoff_utc = et_to_utc('2026-06-20'::date, '09:00'),
  team_a = 'Cape Verde',
  team_b = 'Saudi Arabia',
  group_name = 'H',
  venue = 'Mercedes-Benz Stadium, Atlanta',
...
UPDATE public.matches SET
  match_date = '2026-06-20'::date,
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-20'::date, '12:00'),
  team_a = 'Germany',
  team_b = 'Ecuador',
  group_name = 'E',
  venue = 'AT&T Stadium, Dallas',
...
UPDATE public.matches SET
  match_date = '2026-06-20'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-06-20'::date, '15:00'),
  team_a = 'Netherlands',
  team_b = 'Sweden',
  group_name = 'F',
  venue = 'AT&T Stadium, Dallas',
...
UPDATE public.matches SET
  match_date = '2026-06-20'::date,
  match_time = '18:00 ET',
  kickoff_utc = et_to_utc('2026-06-20'::date, '18:00'),
  team_a = 'Belgium',
  team_b = 'Egypt',
  group_name = 'G',
...
UPDATE public.matches SET
  match_date = '2026-06-21'::date,
  match_time = '22:00 ET',
  kickoff_utc = et_to_utc('2026-06-21'::date, '22:00'),
  team_a = 'Argentina',
  team_b = 'Austria',
  group_name = 'J',
  venue = 'AT&T Stadium, Dallas',
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-22'::date, '12:00'),
  team_a = 'Ivory Coast',
  team_b = 'Germany',
  group_name = 'E',
  venue = 'Arrowhead Stadium, Kansas City',
...
UPDATE public.matches SET
  match_date = '2026-06-22'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-06-22'::date, '15:00'),
  team_a = 'Portugal',
  team_b = 'Colombia',
  group_name = 'K',
  venue = 'NRG Stadium, Houston',
...
UPDATE public.matches SET
  match_date = '2026-06-22'::date,
  match_time = '18:00 ET',
  kickoff_utc = et_to_utc('2026-06-22'::date, '18:00'),
  team_a = 'Iraq',
  team_b = 'Norway',
  group_name = 'I',
  venue = 'Lincoln Financial Field, Philadelphia',
...
UPDATE public.matches SET
  match_date = '2026-06-22'::date,
  match_time = '22:00 ET',
  kickoff_utc = et_to_utc('2026-06-22'::date, '22:00'),
  team_a = 'Iran',
  team_b = 'New Zealand',
  group_name = 'G',
  venue = 'Hard Rock Stadium, Miami',
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-23'::date, '12:00'),
  team_a = 'England',
  team_b = 'Ghana',
  group_name = 'L',
  venue = 'Gillette Stadium, Boston',
...
UPDATE public.matches SET
  match_date = '2026-06-23'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-06-23'::date, '15:00'),
  team_a = 'Croatia',
  team_b = 'Panama',
  group_name = 'L',
  venue = 'BMO Field, Toronto',
...
UPDATE public.matches SET
  match_date = '2026-06-23'::date,
  match_time = '18:00 ET',
  kickoff_utc = et_to_utc('2026-06-23'::date, '18:00'),
  team_a = 'Curacao',
  team_b = 'Ecuador',
  group_name = 'E',
  venue = 'Arrowhead Stadium, Kansas City',
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-24'::date, '12:00'),
  team_a = 'DR Congo',
  team_b = 'Uzbekistan',
  group_name = 'K',
  venue = 'NRG Stadium, Houston',
...
UPDATE public.matches SET
  match_date = '2026-06-24'::date,
  match_time = '22:00 ET',
  kickoff_utc = et_to_utc('2026-06-24'::date, '22:00'),
  team_a = 'Australia',
  team_b = 'Paraguay',
  group_name = 'D',
  venue = 'SoFi Stadium, Los Angeles',
...
UPDATE public.matches SET
  ...
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-06-25'::date, '15:00'),
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-26'::date, '12:00'),
  team_a = 'Haiti',
  team_b = 'Morocco',
  group_name = 'C',
  venue = 'Gillette Stadium, Boston',
...
UPDATE public.matches SET
  match_date = '2026-06-26'::date,
  match_time = '16:00 ET',
  kickoff_utc = et_to_utc('2026-06-26'::date, '16:00'),
  team_a = 'Ivory Coast',
  team_b = 'Curacao',
  group_name = 'E',
  venue = 'Arrowhead Stadium, Kansas City',
...
UPDATE public.matches SET
  ...
  match_time = '12:00 ET',
  kickoff_utc = et_to_utc('2026-06-27'::date, '12:00'),
  team_a = 'Iran',
  team_b = 'Belgium',
  group_name = 'G',
  venue = 'Lumen Field, Seattle',
...
UPDATE public.matches SET
  match_date = '2026-06-27'::date,
  match_time = '16:00 ET',
  kickoff_utc = et_to_utc('2026-06-27'::date, '16:00'),
  team_a = 'Uruguay',
  team_b = 'Cape Verde',
  group_name = 'H',
  venue = 'Estadio Akron, Guadalajara',
...
UPDATE public.matches SET
  match_date = '2026-06-27'::date,
  match_time = '20:00 ET',
  kickoff_utc = et_to_utc('2026-06-27'::date, '20:00'),
  team_a = 'Iraq',
  team_b = 'France',
  group_name = 'I',
  venue = 'MetLife Stadium, New York/NJ',
...
UPDATE public.matches SET
  ...
  match_time = '02:00 ET',
  kickoff_utc = et_to_utc('2026-07-01'::date, '02:00'),
  team_a = 'Winner A',
...
UPDATE public.matches SET
  ...
  match_time = '14:00 ET',
  kickoff_utc = et_to_utc('2026-07-04'::date, '14:00'),
  team_a = 'Runner-up D',
  team_b = 'Runner-up G',
  group_name = NULL,
  venue = 'AT&T Stadium, Dallas',
...
UPDATE public.matches SET
  match_date = '2026-07-05'::date,
  match_time = '21:00 ET',
  kickoff_utc = et_to_utc('2026-07-05'::date, '21:00'),
  team_a = 'Winner M73',
  team_b = 'Winner M75',
  group_name = NULL,
  venue = 'NRG Stadium, Houston',
...
UPDATE public.matches SET
  ...
  match_time = '21:00 ET',
  kickoff_utc = et_to_utc('2026-07-06'::date, '21:00'),
  team_a = 'Winner M76',
  team_b = 'Winner M78',
  group_name = NULL,
  venue = 'MetLife Stadium, New York/NJ',
...
UPDATE public.matches SET
  match_date = '2026-07-07'::date,
  match_time = '21:00 ET',
  kickoff_utc = et_to_utc('2026-07-07'::date, '21:00'),
  team_a = 'Winner M81',
  team_b = 'Winner M82',
  group_name = NULL,
  venue = 'Levi''s Stadium, San Francisco',
...
UPDATE public.matches SET
  match_date = '2026-07-08'::date,
  match_time = '16:00 ET',
  kickoff_utc = et_to_utc('2026-07-08'::date, '16:00'),
  team_a = 'Winner M83',
  team_b = 'Winner M84',
  group_name = NULL,
  venue = 'SoFi Stadium, Los Angeles',
...
UPDATE public.matches SET
  match_date = '2026-07-08'::date,
  match_time = '21:00 ET',
  kickoff_utc = et_to_utc('2026-07-08'::date, '21:00'),
  team_a = 'Winner M85',
  team_b = 'Winner M86',
  group_name = NULL,
  venue = 'Hard Rock Stadium, Miami',
...
UPDATE public.matches SET
  ...
  match_time = '20:00 ET',
  kickoff_utc = et_to_utc('2026-07-09'::date, '20:00'),
  team_a = 'Winner M87',
  team_b = 'Winner M88',
  group_name = NULL,
  venue = 'AT&T Stadium, Dallas',
...
UPDATE public.matches SET
  ...
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-07-11'::date, '15:00'),
  team_a = 'Winner M89',
  team_b = 'Winner M90',
  group_name = NULL,
  venue = 'MetLife Stadium, New York/NJ',
...
UPDATE public.matches SET
  match_date = '2026-07-11'::date,
  match_time = '20:00 ET',
  kickoff_utc = et_to_utc('2026-07-11'::date, '20:00'),
  team_a = 'Winner M91',
  team_b = 'Winner M92',
  group_name = NULL,
  venue = 'AT&T Stadium, Dallas',
...
UPDATE public.matches SET
  match_date = '2026-07-12'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-07-12'::date, '15:00'),
  team_a = 'Winner M93',
  team_b = 'Winner M94',
  group_name = NULL,
  venue = 'Levi''s Stadium, San Francisco',
...
UPDATE public.matches SET
  match_date = '2026-07-12'::date,
  match_time = '20:00 ET',
  kickoff_utc = et_to_utc('2026-07-12'::date, '20:00'),
  team_a = 'Winner M95',
  team_b = 'Winner M96',
  group_name = NULL,
  venue = 'NRG Stadium, Houston',
...
UPDATE public.matches SET
  ...
  match_time = '19:00 ET',
  kickoff_utc = et_to_utc('2026-07-14'::date, '19:00'),
  team_a = 'Winner M97',
  team_b = 'Winner M98',
  group_name = NULL,
  venue = 'MetLife Stadium, New York/NJ',
...
UPDATE public.matches SET
  ...
  match_time = '19:00 ET',
  kickoff_utc = et_to_utc('2026-07-15'::date, '19:00'),
  team_a = 'Winner M99',
  team_b = 'Winner M100',
  group_name = NULL,
  venue = 'AT&T Stadium, Dallas',
...
-- ── 3RD PLACE PLAY-OFF (match 103) ─────────────────────────

UPDATE public.matches SET
  match_date = '2026-07-18'::date,
  match_time = '15:00 ET',
  kickoff_utc = et_to_utc('2026-07-18'::date, '15:00'),
  team_a = 'Loser M101',
  team_b = 'Loser M102',
  group_name = NULL,
  venue = 'Hard Rock Stadium, Miami',
